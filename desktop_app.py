...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.provider_label = QLabel('Provider: not checked')
    ...
    def clear_results(self):
        ...
        self.ask_button.setEnabled(False)
        self.provider_label.setText('Provider: not checked')
    ...
    def on_processing_finished(self, result: ProcessResult):
        ...
        self.provider_label.setText(f'Provider: {result.provider.upper()}')
